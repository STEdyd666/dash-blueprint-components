...
"""
    radiocard(;kwargs...)
    radiocard(children::Any;kwargs...)
    radiocard(children_maker::Function;kwargs...)
...
radiocard(children::Any; kwargs...) = radiocard(;kwargs..., children = children)
radiocard(children_maker::Function; kwargs...) = radiocard(children_maker(); kwargs...)
