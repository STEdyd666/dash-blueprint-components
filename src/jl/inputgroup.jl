...
function inputgroup(; kwargs...)
        available_props = Symbol[:id, :addOnBlur, :className, :defaultValue, :disabled, :fill, :inputClassName, :intent, :large, :leftElement, :leftIcon, :placeholder, :rightElement, :round, :small, :style, :text, :type, :value]
        wild_props = Symbol[]
