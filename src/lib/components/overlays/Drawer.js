...
const SIZE_MAP = {
  'small': DrawerSize.SMALL,
  'standard': DrawerSize.STANDARD,
  'large': DrawerSize.LARGE
}
  ...
  ...others
    ...
    return (
        <BPDrawer
          ...
          size={Object.keys(SIZE_MAP).includes(size) ? SIZE_MAP[size] : size}
          {...others}
        >
        {children}
        </BPDrawer>
...
Drawer.propTypes = {
    ...
    */
    ...
    /**
    * Whether a container-spanning backdrop element should be rendered behind the contents. When false, users 
