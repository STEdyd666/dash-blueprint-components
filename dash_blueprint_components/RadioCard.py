...
- value (string; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'alignIndicator', 'checked', 'className', 'compact', 'disabled', 'elevation', 'interactive', 'label', 'n_clicks', 'selected', 'showAsSelectedWhenChecked', 'style', 'value']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'alignIndicator', 'checked', 'className', 'compact', 'disabled', 'elevation', 'interactive', 'label', 'n_clicks', 'selected', 'showAsSelectedWhenChecked', 'style', 'value']
