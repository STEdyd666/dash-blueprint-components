...
editableText <- function(id=NULL, alwaysRenderInput=NULL, className=NULL, confirmOnEnterKey=NULL, defaultValue=NULL, disabled=NULL, intent=NULL, lastOnCancel=NULL, maxLength=NULL, maxLines=NULL, minLines=NULL, minWidth=NULL, multiline=NULL, n_changes=NULL, n_confirms=NULL, n_edits=NULL, placeholder=NULL, selectAllOnFocus=NULL, type=NULL, value=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'alwaysRenderInput', 'className', 'confirmOnEnterKey', 'defaultValue', 'disabled', 'intent', 'lastOnCancel', 'maxLength', 'maxLines', 'minLines', 'minWidth', 'multiline', 'n_changes', 'n_confirms', 'n_edits', 'placeholder', 'selectAllOnFocus', 'type', 'value'),
