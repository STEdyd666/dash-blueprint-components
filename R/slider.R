...
#' @export
slider <- function(id=NULL, className=NULL, disabled=NULL, format=NULL, initialValue=NULL, intent=NULL, labelPrecision=NULL, labelStepSize=NULL, labelValues=NULL, max=NULL, min=NULL, n_changes=NULL, n_releases=NULL, showTrackFill=NULL, stepSize=NULL, value=NULL, vertical=NULL) {
