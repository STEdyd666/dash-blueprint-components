...
#' @export
switchCard <- function(children=NULL, id=NULL, alignIndicator=NULL, checked=NULL, className=NULL, compact=NULL, disabled=NULL, elevation=NULL, label=NULL, n_clicks=NULL, selected=NULL, showAsSelectedWhenChecked=NULL, style=NULL) {
